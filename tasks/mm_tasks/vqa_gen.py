...
class VqaGenConfig(OFAConfig):
    ...
    unconstrained_training: bool = field(
        default=False,
        metadata={
            "help": "do not use Trie to constrain loss into the closed candidate answer set, default to False. \
...
class VqaGenTask(OFATask):
    def __init__(self, cfg: VqaGenConfig, src_dict, tgt_dict):
        ...
        assert not (
            self.cfg.unconstrained_training
            and self.cfg.val_inference_type != "beamsearch"
