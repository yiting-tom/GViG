...
from data.mm_data.wsdm_vqa_dataset import WSDMVQADataset
...
@register_task("wsdm_vqa", dataclass=WSDMVQAConfig)
class WSDMVQATask(OFATask):
    def __init__(self, cfg: WSDMVQAConfig, src_dict, tgt_dict):
